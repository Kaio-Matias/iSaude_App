...
const DyslexiaSettings = () => {
  ...
  const fontOptions = [
    { id: 'standard', name: 'Fonte Padrão', icon: 'library' },
    { id: 'opendyslexic', name: 'OpenDyslexic', icon: 'library' },
    { id: 'comic-sans', name: 'Comic Sans', icon: 'library' },
    { id: 'arial', name: 'Arial', icon: 'library' },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Dislexia</Text>
        ...
        <View style={styles.mainCard}>
          {fontOptions.map((option) => (
            <View key={option.id} style={styles.infoField}>
              ...
              <TouchableOpacity onPress={() => handleFontSelect(option.id)}>
